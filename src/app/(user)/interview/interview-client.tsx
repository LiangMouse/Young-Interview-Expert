  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 via-purple-50 to-amber-50">
      ...
      <div className="flex h-[calc(100vh-80px)] max-w-7xl mx-auto p-4 gap-4">
            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between p-3 bg-white/50 rounded-2xl">
                  ...
                  <span className="text-sm font-medium text-gray-800">05:23</span>
                </div>
                <div className="flex items-center justify-between p-3 bg-white/50 rounded-2xl">
                  <span className="text-sm text-gray-600">互动次数</span>
                  <span className="text-sm font-medium text-gray-800">12次</span>
                </div>
              </div>
          ...
          <Card className="flex-1 backdrop-blur-md bg-white/60 border-white/30 shadow-xl rounded-3xl overflow-hidden">
            ...
            <CardContent className="flex-1 flex flex-col p-0">
                    ...
                    >
                      ...
                      >
                        <div className="flex items-start space-x-2">
                          {message.emoji && message.type === "ai" && <span className="text-lg">{message.emoji}</span>}
              ...
              <div className="p-6 border-t border-white/20">
                ...
                <p className="text-xs text-gray-500 mt-2 text-center">支持语音输入 · 按住说话 · 松开发送</p>
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        {/* 右侧 - 简历预览和AI点评 */}
        <div className={`transition-all duration-300 ${isRightPanelOpen ? "w-80" : "w-12"}`}>
          <div className="h-full flex flex-col">
            ...
            >
              {isRightPanelOpen ? <ChevronRight className="w-4 h-4" /> : <ChevronDown className="w-4 h-4" />}
            </Button>
                  ...
                  <CardContent>
                    {uploadedFile ? (
                      <div className="p-4 bg-white/50 rounded-2xl">
                        ...
                        <Button variant="outline" size="sm" className="w-full mt-3 rounded-xl bg-transparent">
                          重新上传
                        </Button>
                      </div>
                    ) : (
                      <div className="text-center">
                        ...
                        >
                          ...
                          <p className="text-xs text-gray-500 mt-1">支持 PDF、Word 格式</p>
                        </label>
                      </div>
                    )}
                  </CardContent>
                ...
                <Card className="backdrop-blur-md bg-white/60 border-white/30 shadow-xl rounded-3xl">
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <div className="p-3 bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl border border-green-100">
                        <div className="flex items-center space-x-2 mb-2">
                          ...
                          <span className="text-sm font-medium text-green-700">表现优秀</span>
                        </div>
                        <p className="text-xs text-green-600">回答逻辑清晰，表达流畅自然，展现了良好的沟通能力。</p>
                      </div>
                      ...
                      <div className="p-3 bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl border border-amber-100">
                        ...
                        <p className="text-xs text-amber-600">可以增加更多具体的项目经验描述，让回答更有说服力。</p>
                      </div>

                      <div className="p-3 bg-gradient-to-r from-sky-50 to-blue-50 rounded-2xl border border-sky-100">
                        <div className="flex items-center space-x-2 mb-2">
                          <div className="w-2 h-2 bg-sky-400 rounded-full"></div>
                          <span className="text-sm font-medium text-sky-700">建议</span>
                        </div>
                        <p className="text-xs text-sky-600">建议准备一些关于团队合作的具体案例，这是常见的面试问题。</p>
                      </div>
                    </div>
                    ...
                    <div className="text-center">
                      ...
                      <p className="text-xs text-gray-500 mt-1">继续加油，你很棒！</p>
                    </div>
                  </CardContent>
                </Card>
              </div>
